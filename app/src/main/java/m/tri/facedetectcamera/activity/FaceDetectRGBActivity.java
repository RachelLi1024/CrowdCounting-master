...
/**
 * FACE DETECT EVERY FRAME WILL CONVERT TO RGB BITMAP SO THIS HAS LOWER PERFORMANCE THAN GRAY BITMAP
 */
...
//            Log.i("FaceDetectThread", "running");
            ...
            //refer to http://ostermiller.org/convert_java_outputstream_inputstream.html
            ...
            for (int i = 0; i < MAX_FACE; i++) {
                if (fullResults[i] == null) {
                    ...
                    //android.media.FaceDetector detects face by eyes' distance
                                ...
                                if (faceCroped != null) {
                                    handler.post(new Runnable() {
                                        public void run() {
                                            ...
                                            //set count result according to the number of items in recyclerview
                                            counterW = imagePreviewAdapter.getItemCount();
                                        }
                                    });
                                }
                            }
            ...
            handler.post(new Runnable() {
                public void run() {
                    ...
                    //display result
                    cntCam = (TextView) findViewById(R.id.cntCam);
                    String s1 = Integer.toString(counterW);
                    cntCam.setText(s1);
